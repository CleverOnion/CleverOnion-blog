...
public class UpdateArticleRequest {
     ...
     */
    public UpdateArticleRequest(String title, String content, String summary, Long categoryId, Set<String> tagNames) {
        this.title = title;
     ...
     * 检查是否有任何字段需要更新
     * 
     * @return 如果有字段需要更新返回true，否则返回false
     */
    public boolean hasUpdates() {
        return title != null || content != null || summary != null || 
               categoryId != null || tagNames != null;
    }
