...
const ActionButtons: React.FC<ActionButtonsProps> = ({ isMobileMenuOpen, onMobileMenuToggle }) => {
  ...
  const buttonClass = "p-2.5 text-gray-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-200 cursor-pointer hover:scale-105";
              ...
              {showUserMenu && (
                ...
                >
                  <div className="px-3 py-2 border-b border-gray-100">
                    <p className="text-sm font-medium text-gray-900 truncate">{userInfo.username}</p>
                    <p className="text-xs text-gray-500 truncate">ID: {userInfo.gitHubId}</p>
                  </div>
