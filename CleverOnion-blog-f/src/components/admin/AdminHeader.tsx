            ...
            <div className="relative" ref={menuRef}>
              ...
              >
                <img 
                  ...
                  alt={userInfo.username || userInfo.name || userInfo.githubLogin}
                ...
                {showUserMenu && (
                  ...
                  >
                    <div className="px-3 py-2 border-b border-gray-100">
                      <p className="text-sm font-medium text-gray-900 truncate">{userInfo.username || userInfo.name || userInfo.githubLogin}</p>
