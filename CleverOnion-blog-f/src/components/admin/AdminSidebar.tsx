...
import onionLogo from "../../assets/header/logo/onion.svg";
          ...
          <div className="flex items-center space-x-3 group">
            ...
            {!isCollapsed && (
              <div className="transition-all duration-300">
                <h2 className="text-lg font-semibold text-gray-900 group-hover:text-purple-600 transition-colors duration-300">
                  CleverOnion
                </h2>
                <p className="text-xs text-gray-500 group-hover:text-purple-400 transition-colors duration-300">
                  Admin Panel
                </p>
              </div>
            )}
