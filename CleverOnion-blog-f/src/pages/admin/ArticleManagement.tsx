  ...
  const handleConfirmDelete = async () => {
    try {
      if (deleteTarget.type === "single" && deleteTarget.id) {
        ...
        const newPage =
          articles.length === 1 && currentPage > 0
            ? currentPage - 1
            : currentPage;
  ...
  const renderGridView = () => (
    ...
    >
      {filteredArticles.map((article) => (
        <div
          key={article.id}
          className="group relative bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100/50"
        >
          {/* 选择框 */}
  ...
  return (
    <div className="h-full flex flex-col">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Select
              ...
              onChange={(value) =>
                setTagFilter(value ? Number(value) : undefined)
              }
              options={[
                { value: "", label: "全部标签" },
                ...tags.map((tag) => ({
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div
          className={`${
            selectedArticle && !isFullscreen ? "w-1/2" : "w-full"
            ...
            {totalPages > 1 && (
              <div className="mt-8 flex justify-center">
                ...
                <div className="ml-6 flex items-center text-sm text-gray-600">
                  <span>
                    共 {totalCount} 篇文章，第 {currentPage + 1} / {totalPages}{" "}
                    页
                  </span>
                </div>
              </div>
        ...
        {selectedArticle && (
          <div
            ...
            } transition-all duration-300 border-l border-gray-200 bg-white flex flex-col`}
          >
            {/* 预览头部 */}
                ...
                <div className="mb-8">
                  ...
                  <div className="flex items-center space-x-6 text-sm text-gray-600 mb-4">
                    <div className="flex items-center">
                      ...
                      />
                      <span>
                        {selectedArticle.author?.username || "未知作者"}
                      </span>
                    </div>
                    <div className="flex items-center">
                    ...
                    <div className="flex items-center">
                      ...
                      <span>
                        {(selectedArticle.views || 0).toLocaleString()} 次浏览
                      </span>
                    </div>
                  </div>
